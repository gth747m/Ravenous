...
CREATE TABLE `ingredient` (
  ...
  `ingredient_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `ingredient_type` (
  ...
  `ingredient_type_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `measurement` (
  ...
  `measurement_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `measurement` VALUES (1,'tablespoon'),(2,'teaspoon'),(9,'cup'),(10,'quart'),(11,'gallon'),(12,'milliliter'),(13,'ounce'),(14,'gram'),(15,'pound'),(16,'liter'),(17,'kilogram'),(19,'count');
...
CREATE TABLE `recipe` (
  ...
  `recipe_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `recipe_step` (
  ...
  `recipe_step_instruction` varchar(512) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `recipe_tag` VALUES (3,1,1);
...
CREATE TABLE `recipe_type` (
  ...
  `recipe_type_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `recipe_type` VALUES (5,'Appitizer'),(6,'Main Course'),(8,'Side Dish'),(9,'Dessert'),(10,'Alcohol'),(11,'Drink');
...
CREATE TABLE `tag` (
  ...
  `tag_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`pk_tag`)
...
-- Dump completed on 2020-12-12 13:55:48
